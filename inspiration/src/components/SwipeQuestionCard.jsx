...
// Dating-app style swipe card. Swipe right = Yes, left = No.
// The drag runs entirely on the UI thread; only the commit hops to JS.
const SwipeQuestionCard = React.forwardRef(function SwipeQuestionCard({ question, category, onAnswer }, ref) {
  ...
  // Let the Yes/No buttons drive the exact same fling animation.
    ...
    <View style={s.stage}>
      ...
      <GestureDetector gesture={pan}>
        <Animated.View style={[s.cardWrap, cardStyle]}>
          <BlurView intensity={42} tint="dark" style={s.card}>
