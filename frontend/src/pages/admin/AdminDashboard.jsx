  ...
  return (
    <AdminLayout>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="fs-4 fw-bold text-dark mb-0">System Overview & Management</h2>
      </div>
        ...
        <div className="row g-3 mb-4">
          <div className="col-md-3">
            <div className="card border-0 shadow-sm rounded-3 bg-white p-3 text-center">
              <span className="text-muted small fw-semibold text-uppercase d-block mb-1">Total Filed</span>
              <h3 className="fw-bold text-dark mb-0">{stats.statusBreakdown.total}</h3>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card border-0 shadow-sm rounded-3 bg-white p-3 text-center border-start border-warning border-4">
              <span className="text-muted small fw-semibold text-uppercase d-block mb-1">Pending Review</span>
              <h3 className="fw-bold text-warning mb-0">{stats.statusBreakdown.Pending}</h3>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card border-0 shadow-sm rounded-3 bg-white p-3 text-center border-start border-primary border-4">
              <span className="text-muted small fw-semibold text-uppercase d-block mb-1">In Progress</span>
              <h3 className="fw-bold text-primary mb-0">{stats.statusBreakdown['In Progress']}</h3>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card border-0 shadow-sm rounded-3 bg-white p-3 text-center border-start border-success border-4">
              <span className="text-muted small fw-semibold text-uppercase d-block mb-1">Resolved</span>
              <h3 className="fw-bold text-success mb-0">{stats.statusBreakdown.Resolved}</h3>
            </div>
          </div>
        </div>
      )}
